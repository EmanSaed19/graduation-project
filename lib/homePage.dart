...
class _MyHomePageState extends State<MyHomePage> {
                ...
                child: Form(
                  ...
                  child: ListView.separated(
                      itemBuilder: (context, index) {
                        ...
                        return mySubjectWidget(
                            mySubject: mySubjects[index], number: index + 1);
                      },
  ...
  void calcGPA() {
    ...
    for (var element in mySubjects) {
      sumPoint += getPointMark(
          element.getNumHours(), max(element.getMark(), element.getOldMark()));
  ...
  void calcCGPA() {
    calcGPA();
    double oldPoint = double.parse(lastCGPAController.text) *
        double.parse(cumulativeController.text);
    ...
    cgpaResult = (oldPoint + newPoint - failPoint) /
        (oldNumHours + newNumHours - failNumHours);
